...
class LecturersControllerTest < ActionController::TestCase
  ...
  test "should create lecturer" do
    assert_difference('Lecturer.count') do
      post :create, lecturer: { degree: @lecturer.degree, fullname: @lecturer.fullname, salary: @lecturer.salary }
    end
  ...
  test "should update lecturer" do
    patch :update, id: @lecturer, lecturer: { degree: @lecturer.degree, fullname: @lecturer.fullname, salary: @lecturer.salary }
    assert_redirected_to lecturer_path(assigns(:lecturer))
  end
