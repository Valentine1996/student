...
class RecordbooksControllerTest < ActionController::TestCase
  ...
  test "should create recordbook" do
    assert_difference('Recordbook.count') do
      post :create, recordbook: { bursaly: @recordbook.bursaly, gpaexams: @recordbook.gpaexams, gpatests: @recordbook.gpatests }
    end
  ...
  test "should update recordbook" do
    patch :update, id: @recordbook, recordbook: { bursaly: @recordbook.bursaly, gpaexams: @recordbook.gpaexams, gpatests: @recordbook.gpatests }
    assert_redirected_to recordbook_path(assigns(:recordbook))
  end
